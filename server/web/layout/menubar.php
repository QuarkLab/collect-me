      ...
      <div class="demo-drawer mdl-layout__drawer mdl-color--grey-900 mdl-color-text--blue-grey-50">
        <header class="demo-drawer-header">
          <img src="images/collectme.png" class="main-logo" style="width:100%; height:45px">
          ...
          <div class="demo-avatar-dropdown">
            ...
            <ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect" for="accbtn">
              ...
              <li class="mdl-menu__item">Collector.</li>
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--black">
          ...
          <a class="mdl-navigation__link" href=""><i class="mdl-color-text--green-400 material-icons" role="presentation">people</i>Social</a> -->
          <div class="mdl-layout-spacer"></div>
